        ...
        <div className="flex flex-wrap justify-center sm:border-[#33353F] sm:border">
          <div className="w-full lg:w-10/12">
            <div className="skill-bx wow zoom-in">
              ...
              <div className="item">
                  <img src="/assets/img/html.png" alt="Image" className="w-32 h-32 mx-auto mb-4" />
                  <h5 className="text-xl font-semibold text-center text-white">HTML</h5>
                </div>
                <div className="item">
                  <img src="/assets/img/git.png" alt="Image" className="w-32 h-32 mx-auto mb-4" />
                  <h5 className="text-xl font-semibold text-center text-white">Git</h5>
                </div>
                <div className="item">
                  <img src="/assets/img/mysql1.png" alt="Image" className="w-32 h-32 mx-auto mb-4" />
                  <h5 className="text-xl font-semibold text-center text-white">MySQL</h5>
                </div>
                <div className="item">
                  <img src="/assets/img/db.png" alt="Image" className="w-32 h-32 mx-auto mb-4 rounded-full" />
                  <h5 className="text-xl font-semibold text-center text-white">MongoDB</h5>
                </div>
                <div className="item">
                  <img src="/assets/img/nodejs.png" alt="Image" className="w-32 h-32 mx-auto mb-4" />
                  <h5 className="text-xl font-semibold text-center text-white">Node JS</h5>
                </div>
                <div className="item">
                  <img src="/assets/img/react.png" alt="Image" className="w-32 h-32 mx-auto mb-4" />
